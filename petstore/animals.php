<?php
 ...
 if(isset($_SESSION['user']))
 {
  ...
  echo"<script>location.href='animals.php'</script>";
 }
?>
<html>
    <head>
...
$var=mysqli_query($conn,"select P.pet_id,P.pet_category,A.breed,A.weight,A.height,A.age,fur,P.cost from pets P,animals 
