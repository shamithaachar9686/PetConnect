<?php
 ...
 if(isset($_SESSION['user']))
 {
  ...
  echo"<script>location.href='birds.php'</script>";
 }
?>
<html>
    <head>
...
$var=mysqli_query($conn,"select P.pet_id,P.pet_category,A.type,A.noise, P.cost from pets P,birds A where P.pet_id=A.pet_id ");
